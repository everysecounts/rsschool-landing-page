...
var ThemeSwitcher_module_default = {
	switcher: "_switcher_11u5l_1",
	option: "_option_11u5l_12",
	sun: "_sun_11u5l_33",
	moon: "_moon_11u5l_37"
};
//#endregion
...
var Controls_module_default = {
	controls: "_controls_ororf_1",
	menu: "_menu_ororf_7",
	menuIcon: "_menuIcon_ororf_18",
	menuActive: "_menuActive_ororf_43"
};
//#endregion
//#region src/components/Header/Controls/Controls.js
function menuHref() {
	return `${"/rsschool-landing-page/".replace(/\/?$/, "/")}menu`;
}
var Controls = class {
	constructor() {
		const themeSwitcher = new ThemeSwitcher();
		this.menuLink = createElement("a", {
			className: Controls_module_default.menu,
			href: menuHref()
		}, "Menu", menuIcon$1(Controls_module_default.menuIcon));
		this.element = createElement("div", { className: Controls_module_default.controls }, themeSwitcher.element, this.menuLink);
	}
	setActivePath(path) {
...
var Navigation_module_default = {
	nav: "_nav_174zu_1",
	navList: "_navList_174zu_6",
	navItem: "_navItem_174zu_10",
	navLink: "_navLink_174zu_14"
};
//#endregion
...
function getBasePath() {
	return "/rsschool-landing-page/".replace(/\/$/, "");
}
function navHref({ hash, homeOnly }) {
	if (!homeOnly) return `#${hash}`;
...
var Header_module_default = { header: "_header_kh4my_1" };
//#endregion
...
var Header = class {
	constructor() {
		...
		this.element = createElement("header", { className: Header_module_default.header }, this.logo.element, this.navigation.element, this.controls.element);
	}
	setActivePath(path) {
		this.controls.setActivePath(path);
	}
};
var Main_module_default = { main: "_main_1xt79_1" };
//#endregion
...
var Footer_module_default = {
	footer: "_footer_176fd_1",
	content: "_content_176fd_13",
	footerLeft: "_footerLeft_176fd_17",
	title: "_title_176fd_24",
	titleAccent: "_titleAccent_176fd_31",
	socialLinks: "_socialLinks_176fd_36",
	socialLink: "_socialLink_176fd_36",
	socialIcon: "_socialIcon_176fd_51",
	footerRight: "_footerRight_176fd_72",
	contactTitle: "_contactTitle_176fd_80",
	contactList: "_contactList_176fd_87",
	contactItem: "_contactItem_176fd_93",
	contactLink: "_contactLink_176fd_97",
	contactText: "_contactText_176fd_98",
	contactIcon: "_contactIcon_176fd_106"
};
//#endregion
...
var Router = class {
	...
	getPathname(pathname) {
		const base = "/rsschool-landing-page/".replace(/\/$/, "");
...
var About_module_default = {
	section: "_section_d868u_1",
	description: "_description_d868u_9",
	descriptionAccent: "_descriptionAccent_d868u_15",
	images: "_images_d868u_21",
	imageContainer: "_imageContainer_d868u_35",
	imageLarge: "_imageLarge_d868u_55",
	imageSmall: "_imageSmall_d868u_56"
};
//#endregion
//#region src/components/About/About.js
var IMAGES = [
	{
		src: `/rsschool-landing-page/assets/about-1.avif`,
		alt: "Woman enjoying coffee",
		className: About_module_default.imageLarge
	},
	{
		src: `/rsschool-landing-page/assets/about-2.avif`,
		alt: "Cup of coffee",
		className: About_module_default.imageSmall
	},
	{
		src: `/rsschool-landing-page/assets/about-3.avif`,
		alt: "Man enjoying coffee",
		className: About_module_default.imageSmall
	},
	{
		src: `/rsschool-landing-page/assets/about-4.avif`,
...
var MobileApp_module_default = {
	section: "_section_1traz_1",
	info: "_info_1traz_9",
	title: "_title_1traz_16",
	titleAccent: "_titleAccent_1traz_22",
	description: "_description_1traz_28",
	storeLinks: "_storeLinks_1traz_35",
	storeLink: "_storeLink_1traz_35",
	storeText: "_storeText_1traz_57",
	storeLabel: "_storeLabel_1traz_58",
	storeName: "_storeName_1traz_59",
	storeIcon: "_storeIcon_1traz_66",
	image: "_image_1traz_96"
};
//#endregion
...
var MobileApp = class {
	constructor() {
		...
		const image = createElement("img", {
			...
			src: `/rsschool-landing-page/assets/mobile-screens.avif`,
			alt: "Mobile screens"
		});
		this.element = createElement("section", {
...
//# sourceMappingURL=index-CEhP1Ksg.js.map