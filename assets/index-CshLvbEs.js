...
var ThemeSwitcher_module_default = {
	switcher: "_switcher_1b21o_1",
	option: "_option_1b21o_10",
	sun: "_sun_1b21o_36",
	moon: "_moon_1b21o_40"
};
//#endregion
...
var Controls_module_default = {
	controls: "_controls_tvt1n_1",
	menu: "_menu_tvt1n_16",
	menuActive: "_menuActive_tvt1n_32",
	menuIcon: "_menuIcon_tvt1n_37",
	burger: "_burger_tvt1n_66",
	burgerOpen: "_burgerOpen_tvt1n_108"
};
//#endregion
...
var Controls = class {
	constructor(onBurgerClick) {
		...
		this.menuLink = createMenuLink(Controls_module_default.menu, Controls_module_default.menuIcon);
		this.menuLink.addEventListener("click", (event) => {
			if (this.menuLink.classList.contains(Controls_module_default.menuActive)) event.preventDefault();
		});
...
var Navigation_module_default = {
	nav: "_nav_1tqwd_1",
	navList: "_navList_1tqwd_6",
	navItem: "_navItem_1tqwd_15",
	navLink: "_navLink_1tqwd_23"
};
//#endregion
...
var Navigation = class {
	constructor(onLinkClick) {
		const navItems = NAV_ITEMS.map((item) => {
			...
			if (onLinkClick) link.addEventListener("click", onLinkClick);
...
var MobileMenu = class {
	constructor(onClose) {
		...
		this.menuLink = createMenuLink(MobileMenu_module_default.menu, MobileMenu_module_default.menuIcon);
		this.menuLink.addEventListener("click", (event) => {
			if (this.menuLink.classList.contains(MobileMenu_module_default.menuActive)) event.preventDefault();
			onClose();
		});
...
var Header_module_default = {
	header: "_header_enlog_1",
	desktopNavigation: "_desktopNavigation_enlog_17"
};
//#endregion
...
var Main_module_default = { main: "_main_nsyo1_1" };
//#endregion
...
var Footer_module_default = {
	footer: "_footer_1sh2c_1",
	content: "_content_1sh2c_23",
	footerLeft: "_footerLeft_1sh2c_36",
	title: "_title_1sh2c_43",
	titleAccent: "_titleAccent_1sh2c_54",
	socialLinks: "_socialLinks_1sh2c_59",
	socialLink: "_socialLink_1sh2c_59",
	socialIcon: "_socialIcon_1sh2c_74",
	footerRight: "_footerRight_1sh2c_95",
	contactTitle: "_contactTitle_1sh2c_103",
	contactList: "_contactList_1sh2c_110",
	contactItem: "_contactItem_1sh2c_116",
	contactLink: "_contactLink_1sh2c_120",
	contactText: "_contactText_1sh2c_121",
	contactIcon: "_contactIcon_1sh2c_129"
};
//#endregion
...
var Footer = class {
	constructor() {
		...
		const content = createElement("div", { className: Footer_module_default.content }, createElement("div", { className: Footer_module_default.footerLeft }, createElement("p", { className: Footer_module_default.title }, "Sip, Savor, Smile. ", createElement("span", { className: Footer_module_default.titleAccent }, "It’s coffee time!")), socialLinks), footerRight);
...
var Router = class {
	...
	render() {
		...
		new (this.routes[path] || this.routes["*"])().mount(this.container);
...
var Hero_module_default = {
	section: "_section_1xd6a_1",
	video: "_video_1xd6a_14",
	content: "_content_1xd6a_23",
	title: "_title_1xd6a_45",
	titleAccent: "_titleAccent_1xd6a_58",
	description: "_description_1xd6a_64",
	button: "_button_1xd6a_72",
	menuIcon: "_menuIcon_1xd6a_88"
};
//#endregion
...
getAssetUrl("assets/coffee-1.avif"), getAssetUrl("assets/coffee-2.avif"), getAssetUrl("assets/coffee-3.avif"), getAssetUrl("assets/coffee-4.avif"), getAssetUrl("assets/coffee-5.avif"), getAssetUrl("assets/coffee-6.avif"), getAssetUrl("assets/coffee-7.avif"), getAssetUrl("assets/coffee-8.avif"), getAssetUrl("assets/tea-1.avif"), getAssetUrl("assets/tea-2.avif"), getAssetUrl("assets/tea-3.avif"), getAssetUrl("assets/tea-4.avif"), getAssetUrl("assets/dessert-1.avif"), getAssetUrl("assets/dessert-2.avif"), getAssetUrl("assets/dessert-3.avif"), getAssetUrl("assets/dessert-4.avif"), getAssetUrl("assets/dessert-5.avif"), getAssetUrl("assets/dessert-6.avif"), getAssetUrl("assets/dessert-7.avif"), getAssetUrl("assets/dessert-8.avif");
var Favorites_module_default = {
	section: "_section_16q5t_1",
	title: "_title_16q5t_14",
	titleAccent: "_titleAccent_16q5t_25",
	carousel: "_carousel_16q5t_31",
	arrow: "_arrow_16q5t_40",
	card: "_card_16q5t_68",
	image: "_image_16q5t_76",
	name: "_name_16q5t_83",
	description: "_description_16q5t_90",
	price: "_price_16q5t_102",
	progress: "_progress_16q5t_111",
	progressItem: "_progressItem_16q5t_116",
	progressItemActive: "_progressItemActive_16q5t_122"
};
//#endregion
...
var About_module_default = {
	section: "_section_1xapn_1",
	description: "_description_1xapn_13",
	descriptionAccent: "_descriptionAccent_1xapn_23",
	images: "_images_1xapn_29",
	imageContainer: "_imageContainer_1xapn_43",
	imageLarge: "_imageLarge_1xapn_63",
	imageSmall: "_imageSmall_1xapn_64"
};
//#endregion
...
//# sourceMappingURL=index-CshLvbEs.js.map